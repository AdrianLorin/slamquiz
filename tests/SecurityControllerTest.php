...
class SecurityControllerTest extends WebTestCase
{
    ...
    private function logIn($userName = 'adrian@slamquiz.com', $userRole = 'ROLE_USER')
    {
    ...
    public function testSecuredRoleUser()
    {
        ...
        */
        $this->assertSelectorTextContains('html body h1', 'Liste des catégories');
    ...
    {
        $this->logIn('admin@slamquiz.com', 'ROLE_ADMIN');
        $crawler = $this->client->request('GET', '/category/new');
        ...
        */
        $this->assertSelectorTextContains('html body h1', 'Créer une nouvelle Catégorie');
    }
